...
def audit_libraries_from_file(req_path="requirements.txt"):
    ...
    vulnerability_db = {
        "com.google.android.gms": {"cve": "CVE-2021-4352", "severity": "HIGH", "desc": "Blad weryfikacji certyfikatu"},
        "com.squareup.okhttp": {"cve": "CVE-2016-2402", "severity": "MEDIUM", "desc": "Podatnosc na Man-in-the-Middle"},
    ...
    if not os.path.exists(req_path):
        print(f"BLAD: Nie znaleziono pliku {req_path}! Stworz go najpierw.")
        return
    ...
    for v in found_vulnerabilities:
        icon = "[CRITICAL]" if v["severity"] == "CRITICAL" else f"[{v['severity']}]"
        print(f"{icon} {v['library']} ({v['version']})")
